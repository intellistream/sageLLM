...
from benchmarks.multi_model.config import SyntheticRequestGeneratorConfig
from benchmarks.multi_model.entities import Request
from benchmarks.multi_model.request_generator.base_request_generator import (
    BaseRequestGenerator,
)
from benchmarks.multi_model.request_generator.request_interval_generator_registry import (
    RequestIntervalGeneratorRegistry,
)
from benchmarks.multi_model.request_generator.request_length_generator_registry import (
...
class SyntheticRequestGenerator(BaseRequestGenerator):
    ...
    def get_random_model(self) -> str:
        index = random.randint(0, len(self.config.models) - 1)
