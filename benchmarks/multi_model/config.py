...
from benchmarks.multi_model.types import    (
    RequestIntervalGeneratorType, RequestLengthGeneratorType, RequestGeneratorType
)
...
class BaseRequestGeneratorConfig(BasePolyConfig):
    ...
    models: list[str] = field(
        default_factory=list, metadata={"help": "List of models to serve."}
    )
